...
export const _escapeRegExpPattern = function (str) {
    if (typeof str !== 'string') {
        return str;
    }
    return str.replace(/([\.\*\+\^\$\[\]\\\(\)\|\{\}\,\-\:\?])/g, '\\$1'); // eslint-disable-line no-useless-escape
};
export const _toLowerCase = function (str, reserveReturnValue) {
    if (typeof str !== 'string') {
        return reserveReturnValue && str;
    }
    return str.toLowerCase();
};
export const _toUpperCase = function (str, reserveReturnValue) {
    if (typeof str !== 'string') {
        return reserveReturnValue && str;
    }
    return str.toUpperCase();
};
export const _trim = function (str, delimiter, reserveReturnValue) {
    var patterns = [];
    var regexp;
...
export const _parseLocale = function (strLocale) {
...
export const isRtlLang = function (strLocale) {
...
export const getLangDir = function (strLocale) {
